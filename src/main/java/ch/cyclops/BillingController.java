...
public class BillingController {
    ...
    public String getUserBilling(@ModelAttribute("username") String username, @ModelAttribute("password") String password, Model model) {
        ...
        try {
            ...
            if (udrMeasurement.getPageNumber() != null)
                for (int page = udrMeasurement.getPageNumber(); page < ((float) udrMeasurement.getTotalRecords() / (float) udrMeasurement.getPageSize()); page++) {
                    if (page > 0) {
                        udrMeasurement = getUdrMeasurementForPage(page, tenantId, timeFrom, timeTo);
                    }
...
//        boolean isAdmin = isOpenStackAdmin(username, password);
        ...
        try {
            ...
            for (int page = cdrMeasurement.getPageNumber(); page < ((float) cdrMeasurement.getTotalRecords() / (float) cdrMeasurement.getPageSize()); page++) {
                if (page > 0) {
                    cdrMeasurement = getCdrMeasurementForPage(page, tenantId, timeFrom, timeTo);
                }
...
//            return "switch_users_cdr_chartjs";
    ...
    private void fillChargeData(GenericChargeData data, List<Long> timestamps, HashMap<String, HashMap<String, Double[]>> pairs, HashMap<String, Double[]>
            slicesData, HashMap<String, HashMap<String, Object>> slicePairs, HashMap<String, String> measurementCharts, ArrayList<String> graphSelectionValues, HashMap<String, Double> totalCharge, String
                                        nameField, String tenantId) {
    ...
    private void addChargeToSlicesDataHistogram(HashMap<String, HashMap<String, Double[]>> sliceMap, GenericChargeData data, String resource, Long
            time, List<Long> timestamps, Long timeFrom, long sliceDuration, String measurement) {
        Double charge = data.getCharge();
        timestamps.add(time);
    ...
    private void fillUsageData(GenericUsageData data, HashMap<String, String> measurementUnits, List<Long> timestamps, HashMap<String, HashMap<String, Double[]>>
            pairs, HashMap<String, Double[]>
                                       slicesData, HashMap<String, HashMap<String, Object>> slicePairs, HashMap<String, String> measurementCharts, ArrayList<String> graphSelectionValues, HashMap<String, Double> totalUsage, String
                                       nameField, String tenantId) {
        String pieRepresentation = "number";
        Double[] values;
        HashMap<String, Double[]> metaHash = pairs.get(data.get_class());
     ...
     * @param measurement
     */
    private void addUsageToSlicesDataHistogram(HashMap<String, HashMap<String, Double[]>> sliceMap, GenericUsageData data, String resource, Long
            time, List<Long> timestamps, Long timeFrom, Long sliceDuration, String measurement) {
        Double usage = data.getUsage();
        timestamps.add(time);
    ...
    private void addUsageModel(Model
                                       model, HashMap<String, String> measurementCharts, HashMap<String, String> measurementUnits, HashMap<String, HashMap<String, Double[]>>
                                       pairs, HashMap<String, HashMap<String, Double[]>> sliceMap, HashMap<String, HashMap<String, Object>> slicePairs, List<Long> timestamps, Long timeFrom, String
                                       username, String password, List<String> measurements, ArrayList<String> graphSelectionValues, List<String> tenantNameList, HashMap<String, Double> totalUsage) {
    ...
    private void addChargeModel(Model
                                        model, HashMap<String, String> measurementCharts, HashMap<String, Double> measurementCharges, HashMap<String, HashMap<String, Double[]>>
                                        pairs, HashMap<String, HashMap<String, Double[]>> sliceMap, HashMap<String, HashMap<String, Object>> slicePairs, List<Long> timestamps, String username, String
                                        password, List<String> measurements, ArrayList<String> graphSelectionValues, List<String> tenantNameList, HashMap<String, Double> totalCharge) {
        model.addAttribute("timeSlices", Loader.getSettings().getRepresentationSettings().getTimeSlices());
        model.addAttribute("measurementCharts", measurementCharts);
