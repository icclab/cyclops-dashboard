...
package ch.icclab.cyclops.dashboard.services.iaas.openstack.bills;
...
public class BillGenerator {
    ...
    public void createPDF(String path, OpenstackBill bill, File logo) throws PdfGenerationException {
