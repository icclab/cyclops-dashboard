...
import ch.icclab.cyclops.dashboard.bills.PdfGenerationException;
...
public class BillGenerator {
    ...
    private static final int ITEM_PRICE_OFFSET_X = 50;
    ...
    public void createPDF(String path, TnovaBill bill, File logo) throws PdfGenerationException {
    ...
    private static int drawItemizedDetailTable(PDPageContentStream contentStream, int x, int y, HashMap<String, Double> usage, HashMap<String, Double> resourceCost, HashMap<String, String> unit, HashMap<String, Double> itemCost) throws IOException {
        ...
        for (String key : usage.keySet()) {
            ...
            contentStream.setFont(font, FONT_SIZE);
            contentStream.moveTextPositionByAmount(ITEM_PRICE_OFFSET_X, ITEM_RATE_OFFSET_Y);
