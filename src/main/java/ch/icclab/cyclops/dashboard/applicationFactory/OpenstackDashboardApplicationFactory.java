...
import ch.icclab.cyclops.dashboard.application.OpenstackDashboardApplication;

/**
 * @author Manu
 * Created by root on 16.11.15.
 */
public class OpenstackDashboardApplicationFactory extends AbstractApplicationFactory {
    @Override
    public AbstractApplication loadApplication() {
        return new OpenstackDashboardApplication();
    }
}
