...
(function() {
    ...
    angular.module('dashboard.directives')
        .directive('intervalSpanSelection', IntervalSpanSelectionDeclaration);

    function IntervalSpanSelectionDeclaration() {
        return {
            //scope: {
            //    "onDateChanged": "&"
            //},
            //restrict: 'E',
            templateUrl: 'directives/interval-span-selection/interval-span-selection.html',
            link: onLink
        };
    }
